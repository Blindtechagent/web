...
function sendMsg(event) {
    ...
    var sendMessage = 'New Message' + '%0A' + 'Name: ' + name + '%0A' + 'Email: ' + email + '%0A' + 'WhatsApp number: ' + wa + '%0a' + 'role: ' + selectedRoles + '%0A' + 'other details: ' + userMessage;
    ...
    xhr.onload = function () {
        if (xhr.status >= 200 && xhr.status < 300) {
            ...
            alert('Your form submitted Successfully! keep checking your email and whatsapp time to time as we will contact you soon.');
